...
use assignment::{Assignment, HexAssignments};
...
impl HexBoostData {
    pub fn new(footfall: Footfall, landtype: Landtype, urbanization: Urbanization) -> HexBoostData {
        Self {
            footfall,
            landtype,
            urbanization,
...
mod tests {
    ...
    use crate::assignment::HexAssignments;
